	...
	var lab={
		...
		openNewWindow:function(){
			$("#run_demo_new").click(function(){
				var winExample=window.open('', "_blank", '');
				var _html='<!DOCTYPE HTML>\
							<html>\
							<head>\
							<meta charset="utf-8">\
							<title>实例</title>\
							<script src="http://ecd.tencent.com/css3/js/jquery-1.7.2.min.js"></script>\
							</head>\
							<body>\
							<style type="text/css">';
				...
				winExample.document.open('text/html', 'replace');
				winExample.document.write(_html);
				winExample.document.close();
				return false;
			});
		}
	}
